...
export interface VehicleProfile {
  ...
  heightM: number;
  gvwT: number;
  /** Alias: max gross vehicle weight in tonnes — same as gvwT */
  maxGrossWeightT?: number;
  ...
  /** Minimum road depth required to safely reverse out (defaults to lengthM * 1.5) */
...
export const VEHICLE_PROFILES: Record<VehicleId, VehicleProfile> = {
  bicycle: {
    ...
    lengthM: 1.8, widthM: 0.6, heightM: 1.1, gvwT: 0.1, maxGrossWeightT: 0.1,
  ...
  motorbike: {
    ...
    lengthM: 2.2, widthM: 0.8, heightM: 1.2, gvwT: 0.5, maxGrossWeightT: 0.5,
  ...
  small_car: {
    ...
    lengthM: 3.9, widthM: 1.7, heightM: 1.5, gvwT: 1.8, maxGrossWeightT: 1.8,
  ...
  large_car: {
    ...
    lengthM: 4.9, widthM: 1.95, heightM: 1.65, gvwT: 2.5, maxGrossWeightT: 2.5,
  ...
  swb_van: {
    ...
    lengthM: 4.8, widthM: 2.0, heightM: 2.5, gvwT: 3.0, maxGrossWeightT: 3.0,
    minDriveWidthM: 2.8, minRoadWidthTurnM: 5.8,
    outerTurningRadiusM: 5.8, innerTurningRadiusM: 2.2,
    minThreePointTurnDiameterM: 9.0, hgvRouting: false, requiresAccessPermit: false,
    minReverseDepthM: 7.2,
  },
  lwb_van: {
    id: 'lwb_van', label: 'LWB Van (e.g. Transit LWB)', vehicleClass: 'van',
    lengthM: 5.5, widthM: 2.0, heightM: 2.5, gvwT: 3.5, maxGrossWeightT: 3.5,
    ...
    minReverseDepthM: 8.25,
  },
  luton_van: {
    id: 'luton_van', label: 'Luton Box Van', vehicleClass: 'van',
    lengthM: 6.0, widthM: 2.1, heightM: 3.5, gvwT: 3.5, maxGrossWeightT: 3.5,
    ...
    minReverseDepthM: 9.0,
  },
  tipper_swb: {
    id: 'tipper_swb', label: 'Tipper SWB', vehicleClass: 'van',
    lengthM: 5.0, widthM: 2.1, heightM: 2.6, gvwT: 3.5, maxGrossWeightT: 3.5,
    ...
    minReverseDepthM: 7.5,
  },
  tipper_lwb: {
    id: 'tipper_lwb', label: 'Tipper LWB', vehicleClass: 'van',
    lengthM: 6.2, widthM: 2.2, heightM: 2.8, gvwT: 3.5, maxGrossWeightT: 3.5,
    ...
    minReverseDepthM: 9.3,
  },
  '7_5t_rigid': {
    id: '7_5t_rigid', label: '7.5t Rigid', vehicleClass: 'hgv',
    lengthM: 7.5, widthM: 2.4, heightM: 3.5, gvwT: 7.5, maxGrossWeightT: 7.5,
    ...
    minReverseDepthM: 11.25,
  },
  '18t_rigid': {
    id: '18t_rigid', label: '18t Rigid', vehicleClass: 'hgv',
    lengthM: 10.0, widthM: 2.5, heightM: 4.0, gvwT: 18.0, maxGrossWeightT: 18.0,
    ...
    minReverseDepthM: 15.0,
  },
  '26t_rigid': {
    id: '26t_rigid', label: '26t Rigid', vehicleClass: 'hgv',
    lengthM: 12.0, widthM: 2.55, heightM: 4.0, gvwT: 26.0, maxGrossWeightT: 26.0,
    ...
    minReverseDepthM: 18.0,
  },
  artic_13_6m: {
    id: 'artic_13_6m', label: 'Artic (13.6m trailer)', vehicleClass: 'artic',
    lengthM: 16.5, widthM: 2.55, heightM: 4.2, gvwT: 44.0, maxGrossWeightT: 44.0,
    ...
    minReverseDepthM: 24.75,
  },
  artic_15_5m: {
    id: 'artic_15_5m', label: 'Artic (15.5m mega-trailer)', vehicleClass: 'artic',
    lengthM: 18.75, widthM: 2.55, heightM: 4.2, gvwT: 44.0, maxGrossWeightT: 44.0,
    ...
    minReverseDepthM: 28.125,
  },
  car_trailer: {
    id: 'car_trailer', label: 'Car + Trailer', vehicleClass: 'light',
    lengthM: 9.5, widthM: 2.0, heightM: 1.8, gvwT: 3.5, maxGrossWeightT: 3.5,
    ...
    minReverseDepthM: 14.25,
  },
  horse_trailer: {
    id: 'horse_trailer', label: 'Car + Horse Trailer', vehicleClass: 'light',
    lengthM: 10.5, widthM: 2.2, heightM: 2.8, gvwT: 4.5, maxGrossWeightT: 4.5,
    ...
    minReverseDepthM: 15.75,
  },
  caravan_7m: {
    id: 'caravan_7m', label: 'Car + 7m Caravan', vehicleClass: 'light',
    lengthM: 11.5, widthM: 2.3, heightM: 2.7, gvwT: 4.5, maxGrossWeightT: 4.5,
    ...
    minReverseDepthM: 17.25,
  },
  minibus: {
    id: 'minibus', label: 'Minibus (up to 17 seats)', vehicleClass: 'van',
    lengthM: 6.5, widthM: 2.1, heightM: 2.8, gvwT: 5.0, maxGrossWeightT: 5.0,
    ...
    minReverseDepthM: 9.75,
  },
  coach: {
    id: 'coach', label: 'Full-Size Coach', vehicleClass: 'hgv',
    lengthM: 12.0, widthM: 2.55, heightM: 4.0, gvwT: 18.0, maxGrossWeightT: 18.0,
    minDriveWidthM: 4.0, minRoadWidthTurnM: 14.0,
