...
export default function ScanScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {scanned && result && (
        <View style={[styles.resultCard, { bottom: Math.max(insets.bottom, 16) }]}>
...
const styles = StyleSheet.create({
  ...
  resultCard:  { position: 'absolute', bottom: 16, left: 20, right: 20, backgroundColor: '#111827', borderRadius: 16, padding: 20 },
